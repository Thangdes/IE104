...
const Login = () => {
    ...
    w-[90%] sm:w-[420px] md:w-[440px] lg:w-[460px] xl:w-[480px]
    min-h-[90vh] 
    flex flex-col justify-center
    backdrop-blur-xl shadow-2xl relative overflow-hidden
    transform translate-x-0 sm:translate-x-6 md:translate-x-20 lg:translate-x-32 xl:translate-x-44
  "
                    >
                        ...
                        {/* Header - tăng kích cỡ chữ để tỉ lệ giống ảnh */}
                        <div className="text-center mb-10">
                            <div className="mb-6">
                                <div className="text-5xl lg:text-6xl font-extrabold text-white tracking-wider mb-3 drop-shadow-lg">
                                    SOUNDBITES
                                </div>
                                <div className="text-green-400 text-sm lg:text-base tracking-widest uppercase font-medium">
                                    FEEL THE RHYTHM
                                </div>
                            </div>
                            ...
                            <div className="flex justify-center gap-2 mt-6">
                                {[...Array(4)].map((_, i) => (
                                    <div
                                        key={i}
                                        className="w-1.5 h-6 bg-green-500 rounded-full animate-wave"
                        ...
                        <div className="relative px-4 md:px-6 lg:px-8">
                            ...
                            <p className="text-gray-400 text-center mb-8 text-sm lg:text-base">
                            ...
                            <form className="space-y-6">
                                {/* Email Input */}
                                <div>
                                    <label className="block text-white text-sm lg:text-base font-medium mb-2 tracking-wide">
                                        Email address
                                    </label>
                                    <div className="relative">
                                        <svg
                                            className="absolute left-4 top-1/2 transform -translate-y-1/2 w-6 h-6 text-gray-500 transition-colors duration-300"
                                            fill="currentColor"
                                            viewBox="0 0 24 24"
                                        >
                                        ...
                                        <input
                                            type="email"
                                            className="form-input w-full pl-16 pr-4 py-5 bg-white/8 border border-gray-700 rounded-2xl text-white placeholder-gray-500 focus:outline-none focus:border-green-500 focus:ring-4 focus:ring-green-500/20 transition-all duration-300 text-base lg:text-lg"
                                ...
                                <div className="flex justify-between items-center text-sm lg:text-base">
                                    <label className="checkbox-wrapper flex items-center cursor-pointer text-gray-400">
                                        ...
                                        <div className="checkbox-custom w-5 h-5 border-2 border-gray-600 rounded mr-3 relative transition-all duration-300" />
                                        Remember me
                                    </label>
                                ...
                                <button
                                    type="submit"
                                    className="submit-button w-full bg-green-500 text-black font-semibold py-5 rounded-2xl hover:bg-green-400 hover:transform hover:-translate-y-1 hover:shadow-2xl hover:shadow-green-500/30 transition-all duration-300 relative overflow-hidden group text-base lg:text-lg"
                                >
